...
ggplot(
  ...
  geom_smooth(method = 'loess', linetype = 'dashed') + geom_smooth(method = 'lm', color = 'red') +
...
```{r}
check_heteroscedasticity(nuevo_modelo_lineal_autopercepcion)
check_normality(nuevo_modelo_lineal_autopercepcion)
```
